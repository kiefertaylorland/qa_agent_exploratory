...
import { $ as string, A as readResponseWithSizeLimit, B as _instanceof, C as isExecutableTool, E as isUrlSupported, G as discriminatedUnion, H as array$1, I as validateTypes, J as looseObject, K as lazy, L as withUserAgentSuffix, M as retryWithExponentialBackoff, N as safeParseJSON, O as lazySchema, P as safeValidateTypes, Q as record, R as zodSchema, S as isBuffer, T as isProviderReference, U as boolean, V as _null, W as custom, X as number, Y as never, Z as object$1, _ as fetchWithValidatedRedirects, at as InvalidPromptError, b as getToolCaller, c as DownloadError, ct as UnsupportedFunctionalityError, d as cancelResponseBody, et as union, f as convertBase64ToUint8Array, g as executeTool, h as detectMediaType, i as gateway, j as resolve, l as asArray, lt as getErrorMessage, m as createIdGenerator, n as GatewayError, nt as AISDKError, p as convertUint8ArrayToBase64, q as literal, rt as APICallError, s as DelayedPromise, st as TypeValidationError, t as GatewayAuthenticationError, tt as unknown, u as asSchema, v as filterNullable, w as isFullMediaType, x as isAbortError, y as getRuntimeEnvironmentUserAgent, z as _enum } from "./@ai-sdk/gateway+[...].mjs";
//#region node_modules/.pnpm/ai@7.0.48_zod@4.4.3/node_modules/ai/dist/index.js
...
function resolveToolCallerConfiguration({ tools, toolCallers }) {
	...
	for (const [toolName, tool2] of Object.entries(tools)) {
		if (getToolCaller(tool2) == null) continue;
	...
	for (const [toolName, callers] of Object.entries(configuration)) {
		...
		resolved[toolName] = callers.map((caller) => {
			if (caller === "direct") return caller;
			const callerName = caller != null && typeof caller === "object" ? namesByReference.get(caller) : void 0;
			if (callerName == null) throw new InvalidArgumentError({
				parameter: "experimental_toolCallers",
				value: configuration,
...
//#endregion
//#region node_modules/.pnpm/ai@7.0.48_zod@4.4.3/node_modules/ai/dist/test/index.js
